...
// Using PDO's fetchAll instead of MySQLi's fetch_all
...
// Update competition statuses if needed (you might want to do this in a cron job instead)
...
<body>
    ...
    <div class="container mt-4">
        ...
        <!-- <div class="text-right mb-3">
            <a href="create_competition.php" class="btn btn-primary">Create New Competition</a>
        </div> -->
